...
<title>Gửi mail | Quản trị nội dung</title>
...
<body>
	<%
		...
		session.setAttribute("active", "content-send-mail");
	%>
	<div class="wrapper">
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">
							Quản trị nội dung <small>Gửi mail</small>
						</h1>
						<form action="/14110013/sendmail" method="POST" role="form"
							id="form-mail">

							<div class="form-group">
								<label>Gửi đến</label> <input name="recipient" type="email"
									class="form-control" placeholder="Địa chỉ mail người nhận">
							</div>
