...
<body>
	<%
		...
		session.setAttribute("active", "admin-edit-account");
	%>
	<div class="wrapper">
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<form action="/14110013/editaccount" method="post" role="form"
							enctype="multipart/form-data">
							<div class="row">
								<div class="col-md-6">
									<%
										UserAccount a = new UserAccount();
										AccountUtils uls = new AccountUtils();
									...
									<div class="form-group">
										<label>Tên tài khoản</label> <input type="text"
											...
											placeholder="Tên tài khoản" value="<%=a.UserName%>">
									</div>
										...
										<label>Quyền</label> <select name="RoleId"
											...
											<%
												for (int j = 0; j < ra.size(); j++) {
													if (ra.get(j).Id.indexOf(a.RoleId) > -1) {
											%>
