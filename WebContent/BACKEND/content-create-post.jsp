			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<form action="/14110013/createpost" method="post" role="form" enctype="multipart/form-data">
							...
							<div class="form-group">
								<%
									...
									bs = buls.getArray();
								%>
								<label>Chuyên mục</label> <select id="BlogId" name="BlogId"
									class="form-control input-sm">
									<%
										for (int i = 0; i < bs.size(); i++) {
									%><option value="<%=bs.get(i).Id%>"><%=bs.get(i).Title%></option>
									<%
										}
									%>
								</select>
