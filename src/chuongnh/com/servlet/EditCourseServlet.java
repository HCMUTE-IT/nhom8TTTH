...
import chuongnh.com.model.Course;
 ...
 */
@WebServlet(description = "Chau Minh Hoa", urlPatterns = { "/EditCourseServlet" })
			...
			if (formItems != null && formItems.size() > 0) {
				...
				for (FileItem item : formItems) {
					...
					if (!item.isFormField()) {
						...
						c.CourseName = Convertutf8.convertFromUTF8(formItems.get(1).getString());
						c.Description = Convertutf8.convertFromUTF8(formItems.get(3).getString());
					}
				}
			}
		} catch (Exception ex) {
