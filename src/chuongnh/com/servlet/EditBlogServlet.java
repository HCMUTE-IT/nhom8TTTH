			...
			if (formItems != null && formItems.size() > 0) {
				...
				for (FileItem item : formItems) {
					...
					if (!item.isFormField()) {
						...
						b.Id = formItems.get(0).getString();// request.getParameter("Title");
						b.Title = Convertutf8.convertFromUTF8(formItems.get(1).getString());// request.getParameter("Title");
						b.Content = Convertutf8.convertFromUTF8(formItems.get(3).getString()); // request.getParameter("Content");
					}
				}
			}
		} catch (Exception ex) {
